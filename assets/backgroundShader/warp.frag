...
uniform float u_pixelSize;  // size of "block" in UV space (0..1)

const vec3 mixColor1 = vec3(0.333333, 0.117647, 0.129411);
const vec3 mixColor2 = vec3(0.333333, 0.117647, 0.129411);
